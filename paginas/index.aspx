<%@ Page Language="VB" AutoEventWireup="false" CodeFile="index.aspx.vb" Inherits="paginas_plantilla" %>
    ...
    <div class="container-fluid cuerpo-principal">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <p class="titulo">Mr Coffee Shop  </p>
                <img id="banner" src="../img/coffee-banner.jpg" />
